// ddr3_oontroller_example_sim_e0_if0_s0.v

// This file was auto-generated from qsys_sequencer_110_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.0 200 at 2015.03.04.21:56:19

`timescale 1 ps / 1 ps
module ddr3_oontroller_example_sim_e0_if0_s0 (
	...
	rw_manager_ddr3 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("STRATIXV"),
		.AC_ROM_INIT_FILE_NAME                ("ddr3_oontroller_example_sim_e0_if0_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("ddr3_oontroller_example_sim_e0_if0_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (12288),
		.INIT_FILE        ("ddr3_oontroller_example_sim_e0_if0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	ddr3_oontroller_example_sim_e0_if0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	ddr3_oontroller_example_sim_e0_if0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
