...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "~/altera/14.0/quartus/"
}

set FRAME_BUF_DIR "../frame_buffer"
...
alias com {
  ...
  #compile user verilog files in this directory and frame buffer directory
  vlog -sv "$FRAME_BUF_DIR/*.sv"
  vlog -sv *.sv
}
